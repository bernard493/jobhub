...
export const Review = () => {
  ...
  return (
    <div className="pt-[5rem]  space-y-10">
      ...
      <div className="py-[5rem} grid grid-cols-2 gap-7">
        {/* <Slider {...settings}> */}
          {reviewDetail.map((review) => (
           <div key={review.name} className="bg-white p-5 space-y-7  rounded-2xl ">
           <div>
             <p className="text-gray-600 font-Poppins text-sm ">{review.review}</p>
           </div>
           <div className="flex items-center justify-between">
             <div className="flex items-center space-x-3">
               <div>
               ...
               <div>
                 <p className="text-gray-700 font-Poppins font-bold">{review.name}</p>
                 <p className="text-gray-400 font-Poppins text-[0.8rem] ">{review.title}</p>
               </div>
             </div>
             <div>
               <img
