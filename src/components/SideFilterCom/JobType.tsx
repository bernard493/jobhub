...
interface Props {
  ...
  jobFilterValues: { fulltime: boolean; freelance: boolean;  part_time: boolean };
}
...
export const JobType = ({ jobFilterValues, handleJobFilterChange }: Props) => {
  const {fulltime,freelance,part_time} = jobFilterValues
  return (
