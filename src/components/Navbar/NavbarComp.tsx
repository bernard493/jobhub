...
export const NavbarComp = () => {
  ...
  return (
    <div className="min-h-full z-30 relative ">
        <Disclosure as="nav" className="bg-gray-800">
          {({ open }) => (
            <>
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      <Menu as="div" className="relative ml-3">
                        <div>
                         {isLoggedIn && <Menu.Button className="flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
              ...
              { isLoggedIn && <div className="border-t border-gray-700 pb-3 pt-4">
